...
export default function ServerMigration() {
  return <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1">
                ...
                <div className="grid lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-12 items-center relative z-10">
                  ...
                  <div className="space-y-4 sm:space-y-6 text-center lg:text-left order-last lg:order-first">
                    ...
                    <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold leading-tight">
                      <span className="bg-gradient-to-r from-blue-400 via-blue-500 to-teal-400 bg-clip-text text-transparent animate-pulse hover:scale-105 transition-transform duration-300 cursor-default inline-block px-2 py-1" style={{
                ...
                <Card className="hover:shadow-lg transition-shadow duration-300">
                  <CardContent className="p-4 sm:p-6">
                    <div className="flex items-center mb-3 sm:mb-4">
                      <div className="w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-r from-[#024cbb] via-[#006] to-[#024cbb] rounded-lg sm:rounded-xl flex items-center justify-center mr-3 sm:mr-4 flex-shrink-0">
                        <span className="text-white font-bold text-lg sm:text-xl">1</span>
                      </div>
                      <h3 className="text-lg sm:text-xl font-semibold">Real-time Replication</h3>
                    </div>
                    <p className="text-sm sm:text-base text-muted-foreground">Continuous byte-level replication from primary system to target system ensures data synchronization with minimal network impact.</p>
                  </CardContent>
                </Card>
                ...
                <Card className="hover:shadow-lg transition-shadow duration-300">
                  <CardContent className="p-4 sm:p-6">
                    <div className="flex items-center mb-3 sm:mb-4">
                      ...
                      <h3 className="text-lg sm:text-xl font-semibold">Planned Cutover</h3>
                    </div>
                    <p className="text-sm sm:text-base text-muted-foreground">Scheduled cutover seamlessly transitions users to the new primary system while decommissioning the old infrastructure with near-zero downtime.</p>
                  </CardContent>
                </Card>
              </div>
            </div>
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 mb-8 sm:mb-12">
              {[{
                ...
                <div key={index} className="text-center">
                  <div className="w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-r from-[#024cbb] via-[#006] to-[#024cbb] rounded-full flex items-center justify-center text-white font-bold text-lg sm:text-xl mx-auto mb-3 sm:mb-4 hover:scale-125 transition-transform duration-300">
                    {item.step}
                  </div>
            ...
            <div className="grid lg:grid-cols-2 gap-6 sm:gap-8">
              <Card className="bg-white/5 border-white/10 backdrop-blur-sm">
                <CardContent className="p-4 sm:p-6">
                  ...
                  <ul className="space-y-2 sm:space-y-3">
                    {["AES 256-bit encryption for security", "Bandwidth throttling and compression", "Non-disruptive testing capabilities", "Predictable and repeatable process", "Unified console management", "Third-party tool integration"].map((feature, index) => (
              ...
              <Card className="bg-white/5 border-white/10 backdrop-blur-sm">
                <CardContent className="p-4 sm:p-6">
                  ...
                  <ul className="space-y-2 sm:space-y-3">
                    {["Eliminates migration downtime and data loss", "Reduces human error through automation", "Enables platform agility and flexibility", "Streamlines complex migration projects", "Provides straightforward rollback options", "Maximizes IT investment returns"].map((benefit, index) => (
                      <li key={index} className="flex items-center text-sm sm:text-base text-slate-300">
                        <div className="w-4 h-4 sm:w-5 sm:h-5 bg-green-500 rounded-full flex items-center justify-center mr-2 sm:mr-3 flex-shrink-0">
                          <span className="text-white text-xs font-bold">✓</span>
                        </div>
        ...
        <section className="py-12 sm:py-16 lg:py-20 bg-gradient-to-r from-[#024cbb] via-[#006] to-[#024cbb] relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="text-center mb-8 sm:mb-12">
              ...
              <p className="text-base sm:text-lg md:text-xl text-white/80 max-w-3xl mx-auto px-4">We are the preferred Official OpenText distributor in the Middle East, ensuring authentic licensing and professional support</p>
            </div>
            ...
            <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 items-center max-w-7xl mx-auto">
              <div>
                <div className="bg-white/10 border-2 border-white/20 rounded-lg sm:rounded-2xl p-6 sm:p-8 backdrop-blur-sm">
                  <div className="flex items-center mb-4 sm:mb-6">
                    ...
                    <h3 className="text-lg sm:text-2xl font-semibold text-white">Exclusively Authorized</h3>
                  </div>
              ...
              <div className="space-y-4 sm:space-y-6">
                {[{
                  ...
                  <div key={index} className="bg-white/5 border border-white/10 rounded-lg sm:rounded-xl p-4 sm:p-6 hover:bg-white/10 transition-all duration-300">
                    <div className="flex items-center mb-3 sm:mb-4">
                      <div className="w-8 h-8 sm:w-10 sm:h-10 bg-white/20 rounded-lg flex items-center justify-center mr-3 sm:mr-4 flex-shrink-0">
            ...
            <div className="bg-amber-500/10 border border-amber-500/30 rounded-lg sm:rounded-2xl p-6 sm:p-8 mt-8 sm:mt-12 text-center backdrop-blur-sm">
              ...
              <div className="grid sm:grid-cols-3 gap-4 sm:gap-6">
                {[{
                  ...
                  <div key={index} className="text-center">
                    <div className="text-base sm:text-lg font-bold text-white mb-1">{item.title}</div>
                    <div className="text-xs sm:text-sm text-white/70">{item.desc}</div>
                  </div>
                ))}
              </div>
            </div>
        ...
        <section className="py-12 sm:py-16 lg:py-20">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center max-w-sm sm:max-w-none mx-auto">
              <Button 
                size="lg" 
                className="bg-gradient-to-r from-[#024cbb] via-[#006] to-[#024cbb] hover:shadow-lg hover:shadow-[#024cbb]/25 hover:-translate-y-1 transition-all duration-300 text-sm sm:text-base px-6 sm:px-8 py-2.5 sm:py-3 w-full sm:w-auto"
