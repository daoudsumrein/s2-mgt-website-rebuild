...
export default function EmailArchiving() {
  return (
    <>
      <SEOHead 
        title="MailStore Server - Enterprise Email Archiving Solution"
...
<section id="product-content">
  ...
  <div class="container">
    <div class="hero-section">
      <h1 class="hero-title">MailStore Server</h1>
      <p class="hero-subtitle">On the market since 2006, MailStore Server has grown to become a global standard for email archiving in business following years of successful operation at tens of thousands of companies. Easy to install, reliable and low-maintenance.</p>
      
      <div class="stats-row">
        <div class="stat-item" data-i="0">
          <div class="stat-number">70%</div>
          <div class="stat-label">Storage Reduction</div>
        </div>
        <div class="stat-item" data-i="1">
          <div class="stat-number">100+</div>
          <div class="stat-label">Countries Served</div>
        </div>
        <div class="stat-item" data-i="2">
          <div class="stat-number">19</div>
          <div class="stat-label">Years on Market</div>
        </div>
        <div class="stat-item" data-i="3">
    ...
    <div class="benefits-grid">
      <div class="benefit-card" data-i="0">
        ...
        <p class="benefit-description">Meet GDPR, legal hold requirements, and industry regulations with sophisticated retention policies and tamper-proof storage.</p>
      </div>

      <div class="benefit-card" data-i="1">
        <svg class="benefit-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 7v10c0 2.21 3.582 4 8 4s8-1.79 8-4V7M4 7c0 2.21 3.582 4 8 4s8-1.79 8-4M4 7c0-2.21 3.582-4 8-4s8 1.79 8 4"/>
        </svg>
        <h3 class="benefit-title">Storage Optimization</h3>
        <p class="benefit-description">Reduce storage requirements by up to 70% through intelligent de-duplication and compression technology.</p>
      </div>

      <div class="benefit-card" data-i="2">
        <svg class="benefit-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15"/>
        </svg>
        <h3 class="benefit-title">One-Click Restore</h3>
        <p class="benefit-description">Users can restore emails instantly without administrator intervention, maintaining productivity and reducing IT workload.</p>
      </div>

      <div class="benefit-card" data-i="3">
        <svg class="benefit-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 12h14M5 12a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v4a2 2 0 01-2 2M5 12a2 2 0 00-2 2v4a2 2 0 002 2h14a2 2 0 002-2v-4a2 2 0 00-2-2"/>
        </svg>
        <h3 class="benefit-title">Universal Compatibility</h3>
        <p class="benefit-description">Supports Microsoft Exchange, Microsoft 365, Google Workspace, MDaemon, IceWarp, Kerio Connect, all IMAP/POP3 servers, PST/EML files, and email clients like Outlook and Thunderbird.</p>
      </div>

      <div class="benefit-card" data-i="4">
        <svg class="benefit-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"/>
        </svg>
        <h3 class="benefit-title">Powerful Search</h3>
        <p class="benefit-description">Fast full-text search across emails and attachments with access via original folder structures and multiple interfaces.</p>
      </div>

      <div class="benefit-card" data-i="5">
        <svg class="benefit-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 10V3L4 14h7v7l9-11h-7z"/>
        </svg>
        <h3 class="benefit-title">Business Continuity</h3>
        <p class="benefit-description">Maintain email access during server outages with independent archive access, ensuring uninterrupted operations.</p>
      </div>
    </div>

    <div class="features-section">
      <h2 class="section-title">Integrated Storage Technology</h2>
      <div class="storage-info">
        <div class="storage-card" data-i="0">
        ...
        <div class="storage-card" data-i="1">
      ...
      <h2 class="section-title">Supported Email Systems & Access Methods</h2>
      <div class="systems-grid">
        <div class="system-category" data-i="0">
          <h3>Email Systems</h3>
          <ul>
        ...
        <div class="system-category" data-i="1">
      ...
      <div class="features-list">
        ...
        <div class="feature-item" data-i="5">
          <svg class="feature-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="feature-item" data-i="8">
          <svg class="feature-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="compliance-section">
      <h2 class="section-title">Enterprise-Grade Compliance</h2>
      <p style="color: var(--text-muted); margin-bottom: 2rem;">Built for the most demanding regulatory environments with comprehensive audit trails and retention management.</p>
      
      <div class="compliance-details">
        <div class="compliance-item" data-i="0">
        ...
        <div class="compliance-item" data-i="1">
        ...
        <div class="compliance-item" data-i="2">
    ...
    <div class="cta-section">
      ...
      <div class="testimonials-grid">
        <div class="testimonial-card" data-i="0">
          <div class="quote-mark">"</div>
          <p class="testimonial-text">From an IT administrator's perspective, MailStore is simple to install and easy to manage. When it comes to the archiving methods provided, the solution is enormously versatile and noticeably lightweight.</p>
          <div class="testimonial-author">
            <strong>Ashley Hunt</strong><br>
            <span>Systems Coordinator, PGA of Australia</span>
          </div>
        </div>
        <div class="testimonial-card" data-i="1">
          <div class="quote-mark">"</div>
          <p class="testimonial-text">MailStore Server offers a host of solutions that represent improvements over our previous approach to archiving and the system has simply been operating perfectly for a year and a half.</p>
          <div class="testimonial-author">
      ...
      <h2 class="section-title">System Requirements & Technical Details</h2>
      <div class="tech-grid">
        <div class="tech-card" data-i="0">
          <h3>Supported Operating Systems</h3>
          <p>Microsoft Windows versions currently supported by Microsoft (32-bit and 64-bit versions)</p>
        </div>
        <div class="tech-card" data-i="1">
      ...
      <p class="cta-text">Join tens of thousands of organizations worldwide who trust MailStore Server for their email archiving needs.</p>
    </div>
  </div>
