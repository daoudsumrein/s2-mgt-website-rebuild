              ...
              <div className="relative bg-slate-900/90 border-2 border-blue-500 rounded-2xl p-6 md:p-12 backdrop-blur-sm shadow-2xl hover:shadow-blue-500/20 transition-all duration-500 hover:-translate-y-2 group overflow-hidden">
                ...
                <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center relative z-10">
                  ...
                  <div className="order-first lg:order-last">
                    <div className="relative bg-gradient-to-br from-slate-800 to-slate-700 border border-blue-500/20 rounded-xl overflow-hidden h-[280px] sm:h-[320px] lg:h-[380px] group/video hover:border-blue-500 transition-all duration-400 hover:scale-[1.02] hover:shadow-lg hover:shadow-blue-500/20">
                      {/* Video Container */}
