                ...
                <div className="grid lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-12 items-center relative z-10">
                  ...
                  <div className="order-first lg:order-last">
                    <div className="relative overflow-hidden h-[200px] sm:h-[280px] md:h-[320px] lg:h-[360px] group/media hover:scale-[1.02] hover:shadow-lg hover:shadow-red-500/20 transition-all duration-400 rounded-lg sm:rounded-xl">
                      <div className="w-full h-full bg-gradient-to-br from-red-500/20 via-orange-500/20 to-red-600/20 rounded-lg flex items-center justify-center border border-white/10">
                        <div className="text-center">
                          ...
                          <p className="text-red-300 text-lg font-semibold">Vault Defense</p>
                          <p className="text-red-200/80 text-sm mt-2">Last Line Protection</p>
                        </div>
                      </div>
