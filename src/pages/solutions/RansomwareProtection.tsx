            ...
            <div className="container mx-auto px-4">
              <div className="max-w-6xl mx-auto">
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                  {["Last line of defense against ransomware", "Secure offline data vault", "Clean, verified backup sets", "Resilient backup infrastructure", "Enhanced backup security layer", "Compliance-ready backup environment"].map((deliverable, index) => <Card key={index}>
                ...
                <div className="grid lg:grid-cols-2 gap-12">
                    ...
                    <Card className="border-blue-200 bg-blue-50/50">
                      ...
                      <CardContent>
                        <div className="space-y-3">
                          {["Organizations with critical data assets", "Companies in high-risk industries", "Businesses with remote workforce", "Enterprises requiring compliance", "Organizations with legacy systems", "Companies needing rapid recovery"].map((item, index) => <div key={index} className="flex items-start space-x-3">
                  ...
                  <div>
                    <Card className="border-teal-200 bg-teal-50/50">
                      ...
                      <CardContent>
                        <div className="space-y-3">
                          {["Proactive ransomware prevention", "Rapid recovery capabilities", "Minimal business disruption", "Enhanced security posture", "Reduced financial risk", "Improved business continuity"].map((item, index) => <div key={index} className="flex items-start space-x-3">
