        ...
        <section className="py-16 bg-gradient-to-br from-primary to-blue-600 text-white relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 relative z-10">
            ...
            >
              <div className="p-8">
                <motion.div 
                  className="text-5xl lg:text-6xl font-black mb-3 bg-gradient-to-b from-white to-blue-100 bg-clip-text text-transparent"
              ...
              {[
                ...
                >
                  <Card className="p-8 h-full shadow-lg hover:shadow-xl transition-all duration-300 bg-card">
                    <motion.div 
                      className={`w-20 h-20 ${feature.color} text-white rounded-2xl flex items-center justify-center text-2xl font-bold mx-auto mb-6 shadow-lg`}
              ...
              {[
                {
                  ...
                  benefits: [
                    "Centralized data repository from multiple sources",
                    "Streamlined asset validation process", 
                    "Tribal knowledge capture through expert interviews",
                ...
                },
                {
                  ...
                  benefits: [
                    "Confident migration decision making with accurate data",
                    "Detailed asset dependency mapping and visualization",
                    "Logical move group and bundle determination",
                    "Centralized program management platform",
                ...
                },
                {
                  ...
                  benefits: [
                    "50% reduction in migration time on average",
                    "Automated runbook generation for proper sequencing", 
                    "Clear task ownership and timely communication",
              ...
              {[
                {
                  ...
                  features: [
                    "Break down barriers between business and IT teams",
                    "Collect and display all data in one central location",
                    "Show how applications connect and depend on each other", 
                    "Quickly identify which systems should move together",
                    "Improve communication with experts and decision-makers",
                    "Create automatic reports and visual dashboards"
                  ]
                },
                {
                  ...
                  features: [
                    "Tailor analysis tools to match specific project needs",
                    "Examine complete IT infrastructure at any scale",
                    "Check security requirements, compliance rules, and system importance",
                    "Find hidden patterns using automated examination tools", 
                    "Design plans that keep applications running during moves",
                    "Generate detailed workflows automatically and quickly"
                  ]
                },
                {
                  ...
                  features: [
                    "Connect and automate third-party migration tools",
                    "Create reliable execution plans with proven methods",
                    "Calculate resource needs to get maximum results",
                    "Monitor and control all activities in real-time",
                    "Speed up projects by coordinating multiple work streams",
                    "Spot potential problems before they cause delays"
                  ]
                }
        ...
        <section className="py-20 bg-slate-900 text-white relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 relative z-10">
            <motion.div {...useScrollAnimation()} className="text-center">
              ...
              <motion.div 
                {...useScrollAnimation()}
                className="bg-primary/10 p-12 lg:p-16 rounded-3xl border border-primary/20 backdrop-blur-sm max-w-4xl mx-auto mb-12"
              >
                <motion.div 
                  className="text-6xl lg:text-8xl font-black text-primary mb-4"
                  initial={{ scale: 0.5, opacity: 0 }}
                  whileInView={{ scale: 1, opacity: 1 }}
              ...
              <motion.div 
                {...useScrollAnimation()}
                className="bg-white/10 p-8 lg:p-12 rounded-2xl max-w-4xl mx-auto backdrop-blur-sm"
              >
          ...
          <div className="container mx-auto px-4 text-center">
            <motion.div {...useScrollAnimation()}>
              ...
              <div className="flex flex-col sm:flex-row gap-6 justify-center items-center mb-12">
                <Button 
                  size="lg" 
                  className="bg-white text-primary hover:bg-gray-100 px-8 py-4 text-lg font-semibold w-full sm:w-auto"
