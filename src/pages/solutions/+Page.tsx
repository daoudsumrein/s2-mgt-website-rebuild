            ...
            <div className="grid lg:grid-cols-2 gap-8 md:gap-12">
                        ...
                        <CardContent className="p-4 md:p-6">
                          <div className="flex items-center space-x-3 md:space-x-4">
                            ...
                            <div className="flex-1">
                              ...
                              <p className="text-xs md:text-sm text-muted-foreground">{solution.description}</p>
                            </div>
                            <a href={solution.link}>
                              <ArrowRight className="h-4 w-4 md:h-5 md:w-5 text-primary group-hover:translate-x-1 transition-transform" />
                            </a>
                          </div>
                        </CardContent>
                      </Card>
              ...
              <div className="space-y-6">
                <div className="flex items-center justify-center lg:justify-start space-x-3 mb-6 md:mb-8">
                  ...
                  <h3 className="text-xl md:text-2xl lg:text-3xl font-bold text-center lg:text-left">Cyber Security Solutions</h3>
                </div>
                <div className="space-y-4">
                      ...
                      <Card key={index} className="group hover:shadow-xl hover:scale-[1.02] transition-all duration-300 border-l-4 border-l-teal-500/30 hover:border-l-teal-500">
                        <CardContent className="p-4 md:p-6">
                          <div className="flex items-center space-x-3 md:space-x-4">
                            ...
                            <a href={solution.link}>
                              <ArrowRight className="h-4 w-4 md:h-5 md:w-5 text-teal-500 group-hover:translate-x-1 transition-transform" />
                            </a>
                          </div>
                        </CardContent>
                      </Card>
