                ...
                <div className="grid lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-12 items-center relative z-10">
                  ...
                  <div className="space-y-4 sm:space-y-6 text-center lg:text-left">
                    ...
                    >
                      ...
                      <span className="relative">Disaster Recovery Orchestrator</span>
                    </Badge>
                    ...
                    <p className="text-base sm:text-lg md:text-xl text-slate-300 leading-relaxed max-w-lg mx-auto lg:mx-0">
                      S2 Management delivers TDS TransitionManager DR Orchestrator in MENA. Automate disaster recovery
                      runbooks, failover testing & business continuity.
                    </p>
                    ...
                    <Button
                      ...
                      onClick={() =>
                        window.open(
                          "https://outlook.live.com/calendar/0/deeplink/compose?subject=Disaster%20Recovery%20Consultation",
                          "_blank",
                        )
                      }
                    >
        ...
        <div className="tds-content">
          ...
          <section className="intro-section tds-section">
            <div className="tds-container">
              <h2 className="tds-section-title">
                TransitionManager <span className="highlight-blue">Disaster Recovery Orchestrator</span>
              </h2>
              <p className="intro-text">
                Simplify disaster recovery by identifying gaps, mapping dependencies, and orchestrating failover plans.
                Respond confidently to any disruption with comprehensive features that ensure your organization is
                prepared, resilient, and ready to maintain continuity when it matters most.
              </p>
          ...
          <section className="tds-section">
            <div className="tds-container">
              ...
              <p className="tds-section-subtitle">
                A solid DR plan helps ensure business continuity, minimize financial loss, and support long-term
                success.
              </p>
              ...
              <div className="tds-grid tds-grid-3">
                <div className="importance-item interactive-card">
                  ...
                  <p className="importance-desc">
                    Safeguard critical data and infrastructure from unexpected disruptions, ensuring your valuable
                    business assets remain secure and accessible.
                  </p>
                </div>
                <div className="importance-item interactive-card">
                  ...
                  <p className="importance-desc">
                    Quickly restore systems and services to reduce business impact and maintain operational efficiency
                ...
                <div className="importance-item interactive-card">
                  ...
                  <p className="importance-desc">
                    Avoid penalties and maintain customer trust by meeting regulatory requirements and industry
                    standards for data protection and business continuity.
                  </p>
                </div>
              </div>
            </div>
          ...
          <section className="challenges-section tds-section">
            <div className="tds-container">
              ...
              <p className="tds-section-subtitle">
                Traditional disaster recovery approaches face significant obstacles that can compromise business
                resilience.
              </p>
                ...
                <div>
                  ...
                  <div className="challenge-item">
                    ...
                    <div className="item-content">
                      <h4>Incomplete Discovery Data</h4>
                      <p>Inaccurate or missing DR discovery data creates blind spots in recovery planning.</p>
                    </div>
                  </div>
                  <div className="challenge-item">
                    <div className="challenge-icon">2</div>
                    <div className="item-content">
                      <h4>Ineffective Failover Procedures</h4>
                      <p>Manual and error-prone failover processes that don't scale with business complexity.</p>
                    </div>
                  </div>
                  <div className="challenge-item">
                    <div className="challenge-icon">3</div>
                    <div className="item-content">
                      <h4>Manual Task Management</h4>
                      <p>Labor-intensive communication and task tracking that slows down recovery efforts.</p>
                    </div>
                  </div>
                  <div className="challenge-item">
                    <div className="challenge-icon">4</div>
                    <div className="item-content">
                      <h4>Complex System Dependencies</h4>
                      <p>Unclear relationships between systems make recovery planning difficult and risky.</p>
                    </div>
                  </div>
                  <div className="challenge-item">
                    <div className="challenge-icon">5</div>
                    <div className="item-content">
                      <h4>Compliance Tracking Gaps</h4>
                      <p>No automated regulatory compliance tracking creates audit and penalty risks.</p>
                    </div>
                  </div>
                </div>

                <div>
                  <h3 className="tds-subsection-title" style={{ color: "#dc3545" }}>
                    Business Impact
                  </h3>
                  <div className="impact-item">
                    <div className="impact-icon">⚠️</div>
                    <div className="item-content">
                      <h4>Gaps in Recovery Plans</h4>
                      <p>Missing information increases recovery time and creates additional business risk.</p>
                    </div>
                  </div>
                  <div className="impact-item">
                    <div className="impact-icon">⏱️</div>
                    <div className="item-content">
                      <h4>Longer Failover Times</h4>
                      <p>Extended system restoration delays business recovery and customer service.</p>
                    </div>
                  </div>
                  <div className="impact-item">
                    <div className="impact-icon">❌</div>
                    <div className="item-content">
                      <h4>More Errors & Delays</h4>
                      <p>Manual processes lead to mistakes that compound recovery challenges.</p>
                    </div>
                  </div>
                  <div className="impact-item">
                    <div className="impact-icon">🔄</div>
                    <div className="item-content">
                      <h4>Extended Recovery Windows</h4>
                      <p>Restoring systems in the correct order takes significantly more time without automation.</p>
                    </div>
                  </div>
                  <div className="impact-item">
                    <div className="impact-icon">💰</div>
                    <div className="item-content">
                      <h4>Risk of Penalties</h4>
                      <p>Non-compliance exposure leads to regulatory fines and damaged reputation.</p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <section className="tds-section">
            <div className="tds-container">
              <h2 className="tds-section-title">
                How TransitionManager <span className="highlight-green">Solves</span> These Challenges
              </h2>
              <p className="tds-section-subtitle">
                Our comprehensive approach addresses each challenge with targeted solutions that streamline your
              ...
              <div className="tds-grid tds-grid-3">
                <div className="solution-card interactive-card">
                  ...
                  <p className="solution-desc">
                    Consolidate all IT data points into one comprehensive view, eliminating information gaps and
                    providing complete visibility into your infrastructure.
                  </p>
                </div>
                <div className="solution-card interactive-card">
                  <div className="solution-icon">🤖</div>
                  ...
                  <p className="solution-desc">
                    Guided recovery processes reduce errors and delays through intelligent automation that follows
                ...
                <div className="solution-card interactive-card">
                  ...
                  <p className="solution-desc">
                    Keep teams aligned in real-time with coordinated task management that allows everyone to focus on
                    recovery efforts.
                  </p>
                </div>
                <div className="solution-card interactive-card">
                  ...
                  <p className="solution-desc">
                    Clear visualization of system relationships enables better recovery planning and reduces the risk of
                    cascading failures.
                  </p>
                </div>
                <div className="solution-card interactive-card">
                  ...
                  <p className="solution-desc">
                    Ensure audit readiness and regulatory alignment with automated compliance reporting that reduces
                    manual overhead.
                  </p>
                </div>
              </div>
          ...
          <section className="tds-section">
            <div className="tds-container">
              <h2 className="tds-section-title">
                Key Benefits of Using <span className="highlight-blue">TransitionManager</span> for DR
              </h2>
              ...
              <div style={{ background: "#f8f9fa", borderRadius: "12px", padding: "40px", margin: "40px 0" }}>
                <div className="benefit-flow-item">
                  <div>
                    <h4 style={{ color: "#1a1a1a", fontWeight: "600", marginBottom: "5px" }}>
                      TransitionManager Feature
                    </h4>
                    <p style={{ color: "#666", margin: "0" }}>
                      Data-driven discovery and <span className="highlight-green">dependency mapping</span>
                    </p>
                  ...
                  <div>
                    <h4 style={{ color: "#1a1a1a", fontWeight: "600", marginBottom: "5px" }}>Benefit</h4>
                    <p style={{ color: "#666", margin: "0" }}>
                      Failover groups built on <span className="highlight-green">complete and accurate data</span>
                    </p>
                  </div>
                </div>
                <div className="benefit-flow-item">
                  <div>
                    ...
                    <p style={{ color: "#666", margin: "0" }}>
                      Automated DR runbooks and <span className="highlight-green">event orchestration</span>
                    </p>
                    <div className="progress-indicator">
                      <div className="progress-bar"></div>
                    </div>
                  ...
                  <div>
                    <h4 style={{ color: "#1a1a1a", fontWeight: "600", marginBottom: "5px" }}>Benefit</h4>
                    <p style={{ color: "#666", margin: "0" }}>
                      Improved efficiency - <span className="highlight-green">75% reduction</span> in time & impact
                    </p>
                  </div>
                </div>
                <div className="benefit-flow-item">
                  <div>
                    ...
                    <p style={{ color: "#666", margin: "0" }}>
                      Accurate data and application <span className="highlight-green">dependency info</span>
                    </p>
                    <div className="progress-indicator">
                      <div className="progress-bar"></div>
                    </div>
                  ...
                  <div>
                    <h4 style={{ color: "#1a1a1a", fontWeight: "600", marginBottom: "5px" }}>Benefit</h4>
                    <p style={{ color: "#666", margin: "0" }}>
                      Easily determine "<span className="highlight-green">blast radius</span>" of a failed component
                    </p>
                  </div>
                </div>
                <div className="benefit-flow-item">
                  <div>
                    ...
                    <p style={{ color: "#666", margin: "0" }}>
                      Audit tracking of <span className="highlight-green">all DR tests and events</span>
                    </p>
                    <div className="progress-indicator">
                      <div className="progress-bar"></div>
                    </div>
                  ...
                  <div>
                    <h4 style={{ color: "#1a1a1a", fontWeight: "600", marginBottom: "5px" }}>Benefit</h4>
                    <p style={{ color: "#666", margin: "0" }}>
                      Metrics on actual <span className="highlight-green">adherence to RTO targets</span>
                    </p>
                  </div>
                </div>
                <div className="benefit-flow-item">
                  <div>
                    ...
                    <p style={{ color: "#666", margin: "0" }}>
                      Customizable level-of-complexity <span className="highlight-green">views</span>
                    </p>
                    <div className="progress-indicator">
                      <div className="progress-bar"></div>
                    </div>
                  ...
                  <div>
                    <h4 style={{ color: "#1a1a1a", fontWeight: "600", marginBottom: "5px" }}>Benefit</h4>
                    <p style={{ color: "#666", margin: "0" }}>
                      App criticality, dependency maps and <span className="highlight-green">tailored reports</span>
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div style={{ marginTop: "50px" }}>
                <h3 style={{ textAlign: "center", color: "#1a1a1a", fontSize: "1.8rem", marginBottom: "40px" }}>
                  Proven Results
                </h3>
                <div className="tds-grid tds-grid-auto">
                  ...
                  <div
                    ...
                    style={{ background: "#93C14F", color: "white" }}
                  >
                    <span className="stat-number" style={{ color: "white", fontSize: "2rem" }}>
                      Hit RTO
                    </span>
                    <p className="stat-label" style={{ color: "rgba(255,255,255,0.9)" }}>
                      Targets
                  ...
                  <div
                    ...
                    style={{ background: "#93C14F", color: "white" }}
                  >
                    <span className="stat-number" style={{ color: "white", fontSize: "1.8rem" }}>
                      Improved
                    </span>
                    <p className="stat-label" style={{ color: "rgba(255,255,255,0.9)" }}>
                      Validated Data
          ...
          <section className="features-section tds-section">
            <div className="tds-container">
              ...
              <p className="tds-section-subtitle">
                Whether you have no DR plan or full DR capability, TransitionManager scales with your organization's
                needs.
              </p>
              ...
              <div className="tds-grid tds-grid-3">
                <div className="feature-card interactive-card">
                  ...
                  <p className="feature-desc">
                    Identify gaps in your data and disaster recovery plan, ensuring your organization is prepared for
                    unexpected disruptions with comprehensive assessment tools.
                  </p>
                </div>
                <div className="feature-card interactive-card">
                  <div className="feature-icon">🔗</div>
                  ...
                  <p className="feature-desc">
                    Understand relationships across systems, applications, and infrastructure to create a more resilient
                    and effective DR strategy.
                  </p>
                </div>
                <div className="feature-card interactive-card">
                  <div className="feature-icon">⚡</div>
                  ...
                  <p className="feature-desc">
                    Streamline and automate failover steps, reducing recovery time and minimizing manual errors during
                ...
                <div className="feature-card interactive-card">
                  ...
                  <p className="feature-desc">
                    Provide a clear, centralized view of DR plans that makes it easier to align teams on roles,
                    responsibilities, and recovery procedures.
                  </p>
                </div>
                <div className="feature-card interactive-card">
                  <div className="feature-icon">📈</div>
                  ...
                  <p className="feature-desc">
                    Whether starting from scratch or refining advanced DR plans, TransitionManager scales with your
                    organization's evolving needs and complexity.
                  </p>
                </div>
                <div className="feature-card interactive-card">
                  <div className="feature-icon">🧪</div>
                  ...
                  <p className="feature-desc">
                    Conduct DR drills and simulations to ensure your team is ready and your recovery plan works as
          ...
          <section className="cta-section tds-section-small">
            <div className="tds-container">
              <h2 className="cta-title">
                Ready to Transform Your <span style={{ color: "#00C6F8" }}>Disaster Recovery?</span>
              </h2>
              <p className="cta-subtitle">
                Don't wait for a disaster to test your recovery capabilities. Start building resilience today with
                TransitionManager.
              </p>
