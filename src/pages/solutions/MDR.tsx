                ...
                <div className="grid lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-12 items-center relative z-10">
                  ...
                  <div className="space-y-4 sm:space-y-6 text-center lg:text-left">
                    ...
                    <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold leading-tight">
                      <span className="bg-gradient-to-r from-blue-400 via-blue-500 to-green-400 bg-clip-text text-transparent animate-pulse hover:scale-105 transition-transform duration-300 cursor-default inline-block pb-4" style={{
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                {[
                  ...
                  <motion.div
                    ...
                    className="h-full"
                  >
                    <Card className="relative group overflow-visible border-0 bg-gradient-to-br from-white via-gray-50 to-gray-100 hover:shadow-2xl transition-all duration-500 hover:shadow-blue-500/25 h-full">
                      <div className="absolute inset-0 bg-gradient-to-r from-blue-600/5 via-transparent to-purple-600/5 opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
                      <div className="absolute top-0 -left-full h-full w-1/2 bg-gradient-to-r from-transparent via-white/20 to-transparent group-hover:left-full transition-all duration-1000 transform skew-x-12"></div>
                      <motion.div 
                        className={`absolute -top-6 left-1/2 transform -translate-x-1/2 w-10 h-10 md:w-12 md:h-12 bg-gradient-to-br ${reason.color} text-white rounded-full flex items-center justify-center font-bold text-sm md:text-lg shadow-lg z-30`}
                        whileHover={{ 
                          rotate: [0, -15, 15, -15, 0],
                          scale: 1.2
                        }}
                      ...
                      <CardContent className="pt-8 md:pt-10 p-4 md:p-6 relative z-10 h-full flex flex-col">
                  ...
                  >
                    <Card className="text-center relative group overflow-hidden border-0 bg-gradient-to-br from-white via-gray-50 to-gray-100 hover:shadow-2xl transition-all duration-500 hover:shadow-blue-500/25 h-full">
                      ...
                      <CardContent className="p-8 relative z-10 h-full flex flex-col">
                        ...
                        <p className="text-muted-foreground group-hover:text-gray-700 transition-colors duration-300 flex-1">{item.description}</p>
                      </CardContent>
                    </Card>
                  </motion.div>
                ))}
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                {[
                  ...
                  <motion.div
                    ...
                    className="h-full"
                  >
                    <Card className={`text-center border-l-4 ${item.color} relative group overflow-hidden bg-gradient-to-br from-white via-gray-50 to-gray-100 hover:shadow-xl transition-all duration-500 h-full`}>
                      <div className="absolute inset-0 bg-gradient-to-r from-blue-600/5 via-transparent to-blue-600/5 opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
                      ...
                      <CardContent className="p-6 relative z-10 h-full flex flex-col">
                        ...
                        <p className="text-muted-foreground text-sm group-hover:text-gray-700 transition-colors duration-300 flex-1">{item.description}</p>
                      </CardContent>
                    </Card>
                  </motion.div>
                ))}
