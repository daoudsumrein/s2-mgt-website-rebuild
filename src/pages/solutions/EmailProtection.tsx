      ...
      <main className="flex-1">
        ...
        <section className="bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 py-12 md:py-16 relative overflow-hidden h-[75vh] flex items-center justify-center particle-container">
          ...
          <div className="absolute inset-0 pointer-events-none z-0 particle-field">
            ...
            <div className="absolute inset-0 opacity-20 particles-bg" style={{
              backgroundImage: `
                ...
                radial-gradient(1px 1px at 40px 70px, rgba(34, 197, 94, 0.3), transparent),
                radial-gradient(3px 3px at 90px 40px, rgba(34, 197, 94, 0.5), transparent),
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            >
              {/* Hero Container */}
              <div className="relative bg-slate-900/90 border-2 rounded-xl sm:rounded-2xl p-4 sm:p-6 md:p-8 lg:p-12 backdrop-blur-sm shadow-2xl hover:shadow-green-500/20 transition-all duration-500 hover:-translate-y-2 group overflow-hidden hero-card" style={{ borderColor: "#22C55E" }}>
                {/* Shine effect */}
                ...
                <div className="grid lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-12 items-center relative z-10">
                  ...
                  <div className="space-y-4 sm:space-y-6 text-center lg:text-left">
                    <Badge variant="outline" className="border-green-500/50 text-green-400 bg-green-500/10 hover:bg-green-500/20 hover:border-green-400 hover:scale-105 transition-all duration-300 px-3 sm:px-4 py-1.5 sm:py-2 relative overflow-hidden group/badge text-xs sm:text-sm">
                    ...
                    <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold leading-tight">
                      <span className="bg-gradient-to-r from-green-400 via-green-500 to-emerald-400 bg-clip-text text-transparent animate-pulse hover:scale-105 transition-transform duration-300 cursor-default inline-block" style={{
                  ...
                  <div className="order-first lg:order-last">
                    <div className="relative overflow-hidden h-[200px] sm:h-[280px] md:h-[320px] lg:h-[360px] group/media hover:scale-[1.02] hover:shadow-lg hover:shadow-green-500/20 transition-all duration-400 rounded-lg sm:rounded-xl">
                      <div className="w-full h-full bg-gradient-to-br from-primary/20 via-green-500/20 to-secondary/20 rounded-lg flex items-center justify-center border border-white/10">
                        <div className="text-center">
                          ...
                          <p className="text-green-300 text-lg font-semibold">Email Security</p>
                          <p className="text-green-200/80 text-sm mt-2">Threat Protection</p>
                        </div>
                      </div>
                      
                      {/* Overlay gradient */}
                      <div className="absolute inset-0 bg-gradient-to-r from-green-500/5 via-transparent to-green-500/5 opacity-0 group-hover/media:opacity-100 transition-opacity duration-300 pointer-events-none rounded-xl" />
                    </div>
                  </div>
                </div>
              </div>
