        ...
        <main>
          ...
          <section className="bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 py-12 md:py-16 relative overflow-hidden min-h-screen flex items-center justify-center">
            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
              ...
              >
                {/* Hero Container */}
                <div className="relative bg-slate-900/90 border-2 border-primary rounded-xl sm:rounded-2xl p-4 sm:p-6 md:p-8 lg:p-12 backdrop-blur-xs shadow-2xl hover:shadow-primary/20 transition-all duration-500 hover:-translate-y-2 group overflow-hidden">
                  {/* Shine effect */}
