    ...
    <>
      ...
      <div className="min-h-screen bg-background">
        ...
        <main>
          ...
          <section className="min-h-screen relative overflow-hidden flex items-center px-4 md:px-8 pt-20 bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
            ...
            <div className="relative z-10 max-w-7xl mx-auto w-full">
              ...
              >
                <Badge 
                  variant="outline" 
                  className="border-blue-500/50 text-blue-400 bg-blue-500/10 hover:bg-blue-500/20 hover:border-blue-400 hover:scale-105 transition-all duration-300 px-4 py-2 relative overflow-hidden group/badge mb-8"
                >
                ...
                >
                  ...
                  <span className="font-light bg-gradient-to-r from-blue-400 via-blue-500 to-green-400 bg-clip-text text-transparent" 
                    style={{
                ...
                <motion.p 
                  className="text-lg md:text-xl text-slate-300 leading-relaxed max-w-2xl mx-auto mb-12"
                  initial={{ opacity: 0, y: 30 }}
                  animate={{ opacity: 1, y: 0 }}
                  transition={{ duration: 0.8, delay: 0.6 }}
                >
                  Automated workload migration platform enabling fast, secure movement of Windows and Linux servers to any cloud environment with minimal downtime.
                </motion.p>
                ...
                >
                  ...
                  >
                    <a href="/contact">
                      ...
                      <ArrowRight className="ml-6 group-hover:translate-x-2 transition-transform duration-500 relative" />
                    </a>
                  </Button>
                </motion.div>
              </motion.div>
            ...
            <div className="max-w-7xl mx-auto">
              ...
              >
                <h2 className="text-4xl md:text-5xl font-bold mb-4">
                  Complete Workload Mobility Solutions
                </h2>
                <p className="text-lg text-slate-600 max-w-3xl mx-auto">
                  Transform your infrastructure with comprehensive tools for migration, modernization, optimization, and disaster recovery.
                </p>
              </motion.div>
          ...
          <section className="py-32 px-4 md:px-8 bg-gradient-to-br from-slate-50 to-blue-50">
            <div className="max-w-6xl mx-auto text-center mb-24">
              ...
              >
                ...
                <p className="text-lg text-slate-600 max-w-3xl mx-auto">
                  Seamlessly move workloads between any environment with automated migration tools.
                </p>
              </motion.div>
            </div>
            ...
            >
              {["On-premise to Cloud", "Cloud to Cloud", "Cloud to On-premise"].map((tab, i) => (
                <motion.button
                  key={i}
                  className="px-10 py-4 bg-white rounded-lg border-2 border-transparent hover:border-blue-500 text-slate-600 hover:text-blue-500 transition-all duration-300 text-sm tracking-wider shadow-sm hover:shadow-lg"
            ...
            <motion.div 
              className="max-w-5xl mx-auto aspect-video bg-white rounded-xl shadow-2xl flex items-center justify-center relative overflow-hidden group"
              initial={{ opacity: 0, y: 30 }}
              whileInView={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.8 }}
              viewport={{ once: true }}
          ...
          {/* Statement Section */}
          <section className="py-40 px-4 md:px-8 text-center bg-white">
            <div className="max-w-4xl mx-auto">
              <motion.div
                ...
                viewport={{ once: true }}
              >
                <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold leading-snug mb-8">
                  <span className="bg-gradient-to-r from-blue-500 via-green-500 to-blue-600 bg-clip-text text-transparent"
                    style={{
                      backgroundSize: '300% 300%',
                      animation: 'gradientShift 4s ease-in-out infinite'
                    }}>
          ...
          <section className="grid md:grid-cols-2 min-h-[80vh]">
            <motion.div 
              className="bg-slate-100 relative overflow-hidden flex items-center justify-center"
            ...
            <motion.div 
              className="bg-white p-12 lg:p-24 flex flex-col justify-center relative overflow-hidden group"
              initial={{ opacity: 0, x: 30 }}
              whileInView={{ opacity: 1, x: 0 }}
              transition={{ duration: 0.8 }}
              viewport={{ once: true }}
            >
              {/* Shine effect */}
              <div className="absolute inset-0 bg-gradient-to-r from-transparent via-blue-500/5 to-transparent -translate-x-full group-hover:translate-x-full transition-transform duration-1500 pointer-events-none" />
              
              <span className="text-xs tracking-[0.2em] uppercase text-blue-500 mb-8 inline-block font-semibold">
                OS Modernization
              </span>
              <h2 className="text-3xl lg:text-4xl font-bold leading-snug mb-8">
              ...
              <motion.a 
                href="/contact" 
                className="inline-flex items-center gap-4 text-foreground hover:text-blue-500 hover:gap-8 transition-all duration-300 text-sm tracking-wider group/link"
                whileHover={{ x: 10 }}
              >
          ...
          <section className="grid md:grid-cols-2 min-h-[80vh]">
            <motion.div 
              className="bg-white p-12 lg:p-24 flex flex-col justify-center order-2 md:order-1 relative overflow-hidden group"
              initial={{ opacity: 0, x: -30 }}
              whileInView={{ opacity: 1, x: 0 }}
              transition={{ duration: 0.8 }}
              viewport={{ once: true }}
            >
              ...
              <Button 
                size="lg"
                className="group/btn bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white shadow-lg hover:shadow-blue-500/50 transition-all duration-300 hover:-translate-y-1 hover:scale-105 relative overflow-hidden w-fit px-12 py-6 text-sm tracking-wider"
                asChild
              >
                <a href="/contact">
                  <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/20 to-transparent -translate-x-full group-hover/btn:translate-x-full transition-transform duration-500" />
                  <span className="relative">Get Started Now</span>
                  <ArrowRight className="ml-6 group-hover/btn:translate-x-2 transition-transform duration-500 relative" />
                </a>
              </Button>
            </motion.div>

            <motion.div 
              className="bg-slate-100 relative overflow-hidden flex items-center justify-center order-1 md:order-2"
              initial={{ opacity: 0, x: 30 }}
              whileInView={{ opacity: 1, x: 0 }}
              transition={{ duration: 0.8 }}
              viewport={{ once: true }}
            ...
            <div className="max-w-7xl mx-auto">
              <div className="text-center mb-24">
                ...
                >
                  ...
                  <p className="text-lg text-slate-600 max-w-3xl mx-auto">
                    Choose the perfect module for your workload mobility needs with flexible deployment options.
                  </p>
                </motion.div>
              </div>
              ...
              <div className="grid md:grid-cols-3 gap-8">
                {modules.map((module, index) => {
                  return (
                    <motion.div
                      key={index}
                      className="group bg-slate-50 hover:bg-white rounded-xl p-8 transition-all duration-300 border-2 border-transparent hover:border-blue-200 cursor-pointer relative overflow-hidden flex flex-col"
                    ...
                    >
                      ...
                      <div className="relative z-10">
                        ...
                        <a 
                          href="/contact" 
                          className="inline-flex items-center gap-4 text-foreground hover:text-blue-500 hover:gap-8 transition-all duration-300 text-sm tracking-wider group/link mt-auto"
                        >
                          Get Started 
                          <ArrowRight className="group-hover/link:translate-x-2 transition-transform" />
                        </a>
          ...
          <section className="py-40 px-4 md:px-8 text-center bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white relative overflow-hidden">
            ...
            <div className="max-w-4xl mx-auto relative z-10">
              ...
              >
                ...
                <p className="text-lg text-slate-300 mb-16 leading-relaxed max-w-2xl mx-auto">
