  ...
  return (
    <>
      <SEOHead 
        ...
        description="Exclusive TDS distributor in GCC, UAE and KSA - certified TransitionManager provider for migration planning, dependency mapping and orchestration."
            ...
            <div className="container mx-auto px-4">
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 max-w-6xl mx-auto">
                ...
                <div id="insight" className="bg-white rounded-xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2">
                  <div className="px-6 py-5 flex items-center justify-center" style={{ backgroundColor: 'white', borderBottom: '3px solid #00C6F8' }}>
                    <img 
