              ...
              <div className="text-left">
                <div className="flex items-center gap-3 mb-6">
                  <div className="bg-white backdrop-blur-sm rounded-lg flex items-center justify-center p-2">
                    <svg xmlns="http://www.w3.org/2000/svg" width="150" height="42" viewBox="0 0 200 32" fill="none" className="w-72 h-auto rounded-sm">
                ...
                <h1 className="text-4xl lg:text-6xl font-bold mb-6 leading-tight">
                  ...
                  <span className="block text-blue-200 text-lg">Official Distributor for the Middle East & North Africa</span>
                </h1>
