  ...
  return (
    <div className="min-h-screen flex flex-col bg-white">
      ...
      <main className="flex-1">
        {/* Hero Section */}
        <section className="bg-gradient-to-br from-[#7C8083] via-[#6A6D70] to-[#7C8083] py-12 md:py-16 relative overflow-hidden h-[75vh] flex items-center justify-center">
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            >
              ...
              <div className="bg-white/95 border-2 border-[#2392CF] rounded-2xl p-8 md:p-12 backdrop-blur-sm shadow-2xl hover:shadow-[#2392CF]/20 transition-all duration-500">
                ...
                <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold leading-tight mb-6">
                  <span className="bg-gradient-to-r from-[#2392CF] via-[#1E7FB8] to-[#7C8083] bg-clip-text text-transparent" style={{
                ...
                <p className="text-lg md:text-xl text-[#7C8083] leading-relaxed max-w-3xl mx-auto">
          ...
          <div className="container mx-auto px-4">
            ...
            >
              <div className="text-center mb-16">
                ...
                <h2 className="text-3xl md:text-5xl font-extrabold text-[#7C8083] mb-6">
              ...
              <div className="grid lg:grid-cols-2 gap-8">
                {/* Left Content */}
                <div className="bg-[#7C8083]/5 backdrop-blur-xl border border-[#7C8083]/20 rounded-3xl p-8 md:p-10">
                  <p className="text-lg text-[#7C8083] leading-relaxed mb-6">
                  ...
                  <p className="text-lg text-[#7C8083] leading-relaxed">
                ...
                <div className="space-y-4">
                  {[
                    ...
                    >
                      ...
                      <div>
                        <h4 className="font-semibold text-[#7C8083] text-lg mb-2">{item.title}</h4>
                        <p className="text-[#7C8083]/80 leading-relaxed">{item.desc}</p>
                      </div>
                    </motion.div>
                  ))}
                </div>
          ...
          <div className="container mx-auto px-4">
            ...
            >
              <div className="text-center mb-16">
                ...
                <p className="text-xl text-[#7C8083]/80 max-w-3xl mx-auto">
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
                {[
                  ...
                  <motion.div
                    ...
                    transition={{ delay: index * 0.1 }}
                    viewport={{ once: true }}
                    className="bg-white backdrop-blur-xl border border-[#7C8083]/20 rounded-2xl p-8 text-center hover:bg-white hover:border-[#2392CF]/30 transition-all hover:-translate-y-2 group shadow-sm"
                  >
                    <div className="flex justify-center mb-6">
                      <capability.icon className="w-12 h-12 text-[#2392CF] group-hover:scale-110 transition-transform" />
                    </div>
                    <h3 className="text-xl font-bold text-[#7C8083] mb-3">{capability.title}</h3>
                    <p className="text-[#7C8083]/80 leading-relaxed">{capability.desc}</p>
                  </motion.div>
                ))}
              </div>
            </motion.div>
          ...
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <div className="max-w-4xl mx-auto mb-16">
                <div className="bg-[#7C8083]/5 backdrop-blur-xl border border-[#7C8083]/20 rounded-3xl p-8 md:p-12 shadow-lg">
                  <h3 className="text-2xl md:text-3xl font-bold text-center text-[#7C8083] mb-8">Our Core</h3>
                  <div className="space-y-6 text-lg text-[#7C8083] leading-relaxed">
                    <p>
              ...
              <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
                {[
                  ...
                  <motion.div
                    ...
                    transition={{ delay: index * 0.1 }}
                    viewport={{ once: true }}
                    className="bg-white backdrop-blur-xl border border-[#7C8083]/20 rounded-3xl p-8 hover:bg-white hover:border-[#2392CF]/30 transition-all hover:-translate-y-2 shadow-sm"
                  >
                    <div className="flex justify-center mb-6">
                      <value.icon className="w-12 h-12 text-[#2392CF]" />
                    </div>
                    <h3 className="text-xl font-bold text-[#7C8083] mb-4 text-center">{value.title}</h3>
                    <p className="text-[#7C8083]/80 leading-relaxed text-center">{value.desc}</p>
                  </motion.div>
                ))}
              </div>
            </motion.div>
        ...
        <section className="py-24 bg-[#f8f9fa]">
          <div className="container mx-auto px-4">
            ...
            >
              <div className="bg-white backdrop-blur-xl border border-[#7C8083]/20 rounded-3xl p-10 md:p-16 shadow-lg">
                <h2 className="text-3xl md:text-5xl font-extrabold text-[#7C8083] mb-6">
                  Ready to Partner with S2?
                </h2>
                <p className="text-xl text-[#7C8083]/80 mb-10 leading-relaxed">
                  Let's discuss how our expertise can help transform your IT infrastructure
                </p>
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  <Button 
                    size="lg" 
                    className="bg-gradient-to-r from-[#2392CF] to-[#1E7FB8] hover:from-[#1E7FB8] hover:to-[#1A6EA3] text-white px-8 py-6 text-lg shadow-lg hover:shadow-[#2392CF]/30 transition-all hover:scale-105"
                    asChild
                  >
                    <a href="/contact">
                      Contact Our Team
                  ...
                  <Button 
                    variant="outline" 
                    size="lg"
                    className="bg-white border-[#7C8083]/30 text-[#7C8083] hover:bg-[#7C8083]/10 px-8 py-6 text-lg"
                    asChild
                  >
                    <a href="/services">
                      View Our Services
