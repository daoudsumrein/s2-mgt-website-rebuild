        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="lg:pl-8">
            <div className="grid gap-6">
              <Card className="group hover:shadow-[0_5px_10px_5px_#2393CF40] transition-all duration-300 border-border/50 motion-preset-slide-up motion-delay-400">
              ...
              <Card className="group hover:shadow-[0_5px_10px_5px_#2393CF40] transition-all duration-300 border-border/50">
