        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="lg:pl-8">
            <div className="grid gap-6">
              <Card className="group hover:shadow-[0_10px_10px_10px_#2393CF40] transition-all duration-300 border-border/50 motion-preset-slide-up motion-delay-300">
                <CardContent className="p-6 motion-preset-slide-up motion-delay-300">
