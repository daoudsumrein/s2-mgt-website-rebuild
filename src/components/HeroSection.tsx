        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="lg:pl-8">
            <div className="grid gap-6">
              <Card className="group hover:shadow-[0_5px_10px_0px_#3EB9FA] transition-all duration-300 border-border/50 motion-preset-slide-up motion-delay-400">
              ...
              <Card className="group hover:shadow-[0_5px_5px_5px_#3EB9FA] transition-all duration-300 border-border/50">
