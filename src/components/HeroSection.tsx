        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="lg:pl-8">
            <div className="grid gap-6">
              <Card className="group hover:shadow-[0_10px_10px_10px_#3EB9FA] transition-all duration-300 border-border/50 motion-preset-slide-up motion-delay-400">
              ...
              <Card className="group hover:shadow-[0_10px_10px_10px_#3EB9FA] transition-all duration-300 border-border/50">
